# Generated by Django 2.1.2 on 2018-11-20 22:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actor', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='actor_role', to='actors.Actor')),
                ('movie', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='movie_role', to='movies.Movie')),
            ],
            options={
